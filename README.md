...
```bash
go get -u github.com/nagyp11/iothub
```

To install CLI applications:

```bash
GO111MODULE=on go get -u github.com/nagyp11/iothub/cmd/{iothub-service,iothub-device}
```
...
[cmd/iothub-service](https://github.com/nagyp11/iothub/blob/master/cmd/iothub-service) and [cmd/iothub-device](https://github.com/nagyp11/iothub/blob/master/cmd/iothub-device) are reference implementations of almost all available features. 
